...
public class GitHubContactSalesPage {
  private static final SelenideElement solutionsButton = $(By.xpath("//button[contains(normalize-space(), 'Solutions')]"));
  private static final SelenideElement ciCdButton = $(By.xpath("//a[@href='/solutions/use-case/ci-cd']"));
  private static final SelenideElement contactSalesButton = $(By.xpath(".//a[@href='https://github.com/enterprise/contact?ref_cta=Contact+sales&ref_loc=hero&ref_page=%2Fsolutions_usecase_cicd']"));
